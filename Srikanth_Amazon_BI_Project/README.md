...
│   └── verification\_queries.sql

│

├── notebooks/

│   ├── 01\_api\_exploration.ipynb

│   ├── 02\_data\_cleaning.ipynb

│   ├── 03\_postgresql\_loading.ipynb
...
│   └── amazon\_competitor\_dashboard.pbix
...
│   ├── insights\_and\_recommendations.md

│   └── live\_demo\_script.md
...
!\[Market Overview](screenshots/41\_powerbi\_market\_overview.png)
...
!\[Competitor Analysis](screenshots/42\_powerbi\_competitor\_analysis.png)
...
cd Srikanth\_Amazon\_BI\_Project
...
conda create --name srikanth\_amazon\_bi python=3.11 -y

conda activate srikanth\_amazon\_bi
...
AMAZON\_SCRAPER\_API\_KEY=your\_api\_key\_here
...
DB\_NAME=amazon\_competitor\_bi
...
Then connect to `amazon\_competitor\_bi` and run:



```text

database/create\_tables.sql
...
python scripts/run\_etl\_pipeline.py
...
powerbi/amazon\_competitor\_dashboard.pbix
